      ...
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div
            ...
            id="mobile-menu-2"
          >
            <ul className="flex flex-col items-center inline-block w-full mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <Link
                  to="/home"
                  className="block py-2 pr-4 pl-3 text-white bg-sky-500 rounded md:bg-transparent md:text-sky-500 md:p-0 dark:text-white"
                  aria-current="page"
                >
                  Home
                </Link>
